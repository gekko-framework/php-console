...
class FastCGICommand extends Command
{
    ...
    private function startWindows(ConsoleContext $ctx) : int
    {
        ...
        $previous_pids = [];
        $fd = popen("tasklist /fi \"imagename eq php-cgi.exe\" /fo CSV /nh", "r");
        ...
        pclose(popen("start /B php-cgi -b 127.0.0.1:9123", "r"));
    ...
    {
        $pid_file = $ctx->toLocalPath("/.tmp/php/.php-cgi.pid");
        if (!\file_exists($pid_file))
            return -1;
